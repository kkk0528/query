...
public class SkipSet <E extends Comparable <? super E>>{
    ...
    List<List<CipherPub>> Paixuji_temp= new ArrayList<>();
     ...
     *
     * @author 邱信强
     * @createDate 创建时间：2020-8-11 15:51:23
     * @Descrption:		添加层
     * @param i			需要添加的层数
     * @param value		添加的内容
     ...
     *
     * @author 邱信强
     * @createDate 创建时间：2020-8-11 16:02:35
     ...
     *
     * @author 邱信强
     * @createDate 创建时间：2020-8-12 10:09:18
...
//                lineTemp.value= Integer.parseInt(null);
